		...
		public override void OnInspectorGUI()
		{
			...
			if (EditorApplication.isPlaying)
			{
				EditorGUILayout.HelpBox(
					"\nCurrent running game has ID " + Main.instance.gameDefinition.gameId +
					". Make sure that is the correct game.", MessageType.Info, true);
			...
			{
				EditorGUILayout.HelpBox("\nEnter playmode to enable migration of game and levels from json",
